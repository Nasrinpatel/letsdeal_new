                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-pink mb-1">
                                        <?php foreach ($categorychk as $catchk) { ?>
                                            <input type="checkbox" name="category_ids[]" id="category_ids" value="<?php echo $catchk->id; ?>" class="form-check-input category" <?= (in_array($catchk->id, explode(',', $leadform->category_ids)) && form_error('category_ids[]') == '') ? 'checked' : '' ?> multiple><?php echo $catchk->name; ?><br>
                                                    ...
                                                    <div class="form-check-inline mb-1 subcategory-container" id="category-<?= $catchk->id ?>">
                                                        ...
                                                        foreach ($subcategorychk as $subcatchk) { ?>
                                                            <div class="form-check form-check-inline">
                                                                <input type="checkbox" name="sub_category_ids[]" id="sub_category_ids" value="<?php echo $subcatchk->id; ?>" class="form-check-input subcategory" data-category="<?php echo $subcatchk->property_category_id; ?>" <?= (in_array($subcatchk->id, explode(',', $leadform->sub_category_ids)) && form_error('sub_category_ids[]') == '') ? 'checked' : '' ?> multiple>
