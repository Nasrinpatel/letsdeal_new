                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <button type="button" class="btn btn-danger waves-effect waves-light mb-2" data-bs-toggle="modal" data-bs-target="#agent-reminders-modal" style="margin-right: 5px;">Add Reminder</button>
                                <a href="<?= base_url('admin/Agentmaster') ?>" class="btn btn-primary waves-effect waves-light mb-2">Back</a>
                            </ol>
                        </div>
                        <h4 class="page-title">Channel Partner Reminder</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap table-striped" id="agent_reminders_datatable">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <!-- <th>Name</th> -->
...
<script>
    ...
    var reminders_table = $('#agent_reminders_datatable').DataTable({
        responsive: true,
        ajax: "<?php echo base_url('admin/Agentmaster/all_reminders/' . $agent_id); ?>",
