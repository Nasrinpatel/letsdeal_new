...
class Prosubcategory extends CI_Controller
{
	...
	public function all()
	{
		...
		foreach ($subcategory as $value) {
			...
			$button = '<a href="' . base_url('admin/prosubcategory/edit/' . $value['id']) . '" class="action-icon edit-btn" data-id="' . $value['id'] . '" data-bs-toggle="modal" data-bs-target="#prosubcategoryedit-modal"><i class="mdi mdi-square-edit-outline text-warning"></i></a>
