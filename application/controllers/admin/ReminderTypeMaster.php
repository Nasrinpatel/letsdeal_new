...
class ReminderTypeMaster extends CI_Controller
{
	...
	public function all()
	{
		...
		foreach ($remitypes as $value) {
			...
			$button = '<a href="' . base_url('admin/ReminderTypeMaster/edit/' . $value['id']) . '" class="action-icon edit-btn" data-id="' . $value['id'] . '" data-bs-toggle="modal" data-bs-target="#remindertypeedit-modal"><i class="mdi mdi-square-edit-outline text-warning"></i></a>
