...
class Phase extends CI_Controller
{
	...
	public function all()
	{
		...
		foreach ($phases as $value) {
			$button = '<a href="' . base_url('admin/phase/edit/' . $value['id']) . '" class="action-icon edit-btn" data-id="' . $value['id'] . '" data-bs-toggle="modal" data-bs-target="#phaseedit-modal"><i class="mdi mdi-square-edit-outline text-warning"></i></a>
