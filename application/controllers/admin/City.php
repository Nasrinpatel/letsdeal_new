...
class City extends CI_Controller
{
	...
	public function all()
	{
		...
		foreach ($cites as $value) {
			$button = '<a href="' . base_url('admin/city/edit/' . $value['id']) . '" class="action-icon edit-btn" data-id="' . $value['id'] . '" data-bs-toggle="modal" data-bs-target="#cityedit-modal"><i class="mdi mdi-square-edit-outline text-warning"></i></a>
