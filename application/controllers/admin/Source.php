...
class Source extends CI_Controller {
	...
	public function all()
	{
		...
		foreach ($sources as $value) { 
			$button = '<a href="'.base_url('admin/source/edit/' .$value['id']).'" class="action-icon edit-btn" data-id="'.$value['id'].'" data-bs-toggle="modal" data-bs-target="#sourceedit-modal"><i class="mdi mdi-square-edit-outline text-success"></i></a>
